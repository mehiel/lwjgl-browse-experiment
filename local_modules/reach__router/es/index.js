...
import { startsWith, pick, resolve, match, insertParams, validateRedirect, makeCancelable } from "./lib/utils";
...
var LinkImpl = function (_React$Component3) {
  _inherits(LinkImpl, _React$Component3);

  function LinkImpl() {
    var _temp3, _this6, _ret3;

    _classCallCheck(this, LinkImpl);

    for (var _len3 = arguments.length, args = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
      args[_key3] = arguments[_key3];
    }

    return _ret3 = (_temp3 = (_this6 = _possibleConstructorReturn(this, _React$Component3.call.apply(_React$Component3, [this].concat(args))), _this6), _this6._navigationCancelablePromise = null, _this6.state = {
      navigating: false
  ...
  LinkImpl.prototype.render = function render() {
    ...
    var _props3 = this.props,
        ...
        props = _objectWithoutProperties(_props3, ["innerRef"]);
        ...
        return React.createElement(
          ...
          function (_ref5) {
            ...
            var to = props.to,
                ...
                anchorProps = _objectWithoutProperties(props, ["to", "state", "replace", "getProps", "children"]);
...
var Link = forwardRef(function (_ref6, ref) {
  var innerRef = _ref6.innerRef,
      props = _objectWithoutProperties(_ref6, ["innerRef"]);
...
var RedirectImpl = function (_React$Component4) {
  ...
  RedirectImpl.prototype.render = function render() {
    var _props5 = this.props,
        navigate = _props5.navigate,
        to = _props5.to,
        from = _props5.from,
        replace = _props5.replace,
        state = _props5.state,
        noThrow = _props5.noThrow,
        props = _objectWithoutProperties(_props5, ["navigate", "to", "from", "replace", "state", "noThrow"]);
