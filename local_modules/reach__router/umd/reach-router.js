...
var createHistory = function createHistory(source, options) {
  ...
  var rejectTransition = function rejectTransition() {};
  ...
  return {
    ...
    navigate: function navigate(to) {
      ...
      location = getLocation(source);
      transitioning = true;
      var transition = new Promise(function (res, rej) {
        rejectTransition();
...
var LinkImpl = function (_React$Component3) {
  inherits(LinkImpl, _React$Component3);

  function LinkImpl() {
    var _temp3, _this6, _ret3;

    classCallCheck(this, LinkImpl);

    for (var _len3 = arguments.length, args = Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
      args[_key3] = arguments[_key3];
    }

    return _ret3 = (_temp3 = (_this6 = possibleConstructorReturn(this, _React$Component3.call.apply(_React$Component3, [this].concat(args))), _this6), _this6._navigationCancelablePromise = null, _this6.state = {
      navigating: false
    }, _this6.stopNavigation = function (canceled) {
      return !canceled && _this6.setState({ navigating: false });
    }, _this6.onClick = function (href, state, replace, onClickProp) {
      return function (event) {
        if (onClickProp) onClickProp(event);
        if (shouldNavigate(event)) {
          event.preventDefault();
          // set current link state as navigating
          _this6.setState({ navigating: true });
          ...
          var cp = makeCancelable(navigate(href, { state: state, replace: replace }));

          // set promise handlers after creation in order to be queued
          // after cancelation handlers
          cp.promise.then(function () {
            return _this6.stopNavigation();
          }).catch(function (e) {
            return _this6.stopNavigation(e && e.isCanceled ? true : false);
          });

          // attach cancelable promise to the component instance
          // to be able to reference and cancel it from componentWillUnmount
          _this6._navigationCancelablePromise = cp;
        }
      };
    }, _temp3), possibleConstructorReturn(_this6, _ret3);
  }

  LinkImpl.prototype.componentWillUnmount = function componentWillUnmount() {
    var ncp = this._navigationCancelablePromise;
    if (ncp) ncp.cancel();
  };

  LinkImpl.prototype.render = function render() {
    var _this7 = this;

    var _props3 = this.props,
        innerRef = _props3.innerRef,
        props = objectWithoutProperties(_props3, ["innerRef"]);

    var navigating = this.state.navigating;
    return React.createElement(
      BaseContext.Consumer,
      null,
      function (_ref4) {
        ...
        return React.createElement(
          ...
          function (_ref5) {
            ...
            var to = props.to,
                ...
                anchorProps = objectWithoutProperties(props, ["to", "state", "replace", "getProps", "children"]);
            ...
            return React.createElement(
              ...
              _extends({
                ...
                href: href,
                onClick: _this7.onClick(href, state, replace, anchorProps.onClick)
              }),
...
var Link = forwardRef(function (_ref6, ref) {
  var innerRef = _ref6.innerRef,
      props = objectWithoutProperties(_ref6, ["innerRef"]);
  return React.createElement(LinkImpl, _extends({}, props, { innerRef: ref || innerRef }));
});
...
var RedirectImpl = function (_React$Component4) {
  inherits(RedirectImpl, _React$Component4);
  ...
  RedirectImpl.prototype.componentDidMount = function componentDidMount() {
    var _props4 = this.props,
        ...
        to = _props4.to,
        from = _props4.from,
        _props4$replace = _props4.replace,
        replace = _props4$replace === undefined ? true : _props4$replace,
        state = _props4.state,
  ...
  RedirectImpl.prototype.render = function render() {
    var _props5 = this.props,
        navigate$$1 = _props5.navigate,
        to = _props5.to,
        from = _props5.from,
        replace = _props5.replace,
        state = _props5.state,
        noThrow = _props5.noThrow,
        props = objectWithoutProperties(_props5, ["navigate", "to", "from", "replace", "state", "noThrow"]);
